...
class EmployeeMsApplicationTests {
	...
	public void fetchEmployeesTest() {
		when(empRepo.findAll()).thenReturn(
				Stream.of(new Employee(1, 101, "Sumukha", "Mysore", "Bangalore")).collect(Collectors.toList()));
	...
	public void getByNameTest() {
		String name = "Sumukha";
		when(empRepo.findByName(name)).thenReturn(
				Stream.of(new Employee(1, 101, "Sumukha", "Mysore", "Mysore")).collect(Collectors.toList()));
